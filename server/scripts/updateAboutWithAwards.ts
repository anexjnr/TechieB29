...
async function run() {
  try {
    ...
    for (const item of items) {
      ...
      const leadership = [
        { name: 'Sarah Johnson', role: 'CEO & Co-Founder', bio: 'Former VP at Google, leading our vision and strategy', avatarId: null },
        { name: 'Michael Chen', role: 'CTO & Co-Founder', bio: 'Ex-Tesla engineer, driving our technical innovation', avatarId: null },
        { name: 'Emily Rodriguez', role: 'VP of Design', bio: 'Award-winning designer with 15+ years experience', avatarId: null },
      ];
